...
def timedMode():
  ...
  while end - start < timeLimit:
    ...
    red = (255, 0, 0)
    green = (0, 255, 0)
    myfont = pygame.font.SysFont("Ariel", 420) #Large font for score
    ...
    screen.blit(label, (75,20)) #put the score text on the screen
...
def fireMode():
  ...
  black = (0,0,0)
  sienna = (160,82,45)
  myfont = pygame.font.SysFont("Ariel", 230) #Large font for score
...
def skillMode(score=0, level=1):
  ...
  green = (0,255,0)
  blue = (0,0,255)
  myfont = pygame.font.SysFont("Ariel", 120) #Large font for score
